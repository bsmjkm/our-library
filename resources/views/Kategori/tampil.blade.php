...
@section('content')
    @if (Auth::user()->isAdmin == 1)
        <a href="/kategori/create" class="btn btn-primary mb-3">Add Category</a>
    @endif
    ...
    <div class="col-lg-auto">
        <div class="card mb-4">
                        ...
                        @forelse ($kategori as $key => $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if (Auth::user()->isAdmin == 1)
                                        <button class="btn btn-primary"><a href="/kategori/{{ $item->id }}"
            ...
            @if (Auth::user()->isAdmin == 0)
                <a href="/kategori/{{ $item->id }}" class="btn-sm btn-primary px-3 py-2"
