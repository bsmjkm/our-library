...
@section('content')
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="button mt-2"><a href="/anggota" class="text-light">Details</a></div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100 bg-gradient-danger">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-sm text-light font-weight-bold text-uppercase mb-1" style="font-size:.8`rem;">Borrower History</div>
                            <div class="h5 mb-0 mr-3 font-weight-bold text-light">{{ $jumlah_riwayat }}</div>
                            <div class="button mt-2"><a href="#" class="text-light">Details</a></div>
                        </div>
                        <div class="col-auto">
    ...
    <h1 class="text-dark">Loan History</h1>
